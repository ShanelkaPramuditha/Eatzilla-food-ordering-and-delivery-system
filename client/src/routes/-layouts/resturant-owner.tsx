...
const Sidebar = ({ isExpanded }: SidebarProps) => {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-50 flex h-screen w-[90px] flex-col border-r border-gray-200 bg-white px-5 text-gray-900 transition-all duration-300 ease-in-out lg:mt-0 lg:w-[290px] lg:translate-x-0 dark:border-gray-800 dark:bg-gray-900`}
    >
            ...
            <form>
              <div className='relative'>
                ...
                <input
                  type='text'
                  placeholder='Search'
                  className='dark:bg-dark-900 shadow-theme-xs dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:border-indigo-300 focus:ring-2 focus:ring-indigo-500/10 focus:outline-hidden xl:w-[430px] dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30'
                />
              </div>
            </form>
          </div>
        ...
        <DropdownMenuContent className='mt-5.5 mr-5 w-[335px]'>
          ...
          <div className='max-h-100 overflow-y-auto px-4 py-2'>
            {notifications.map((notif, index) => (
              <DropdownMenuItem key={index} className='items-start gap-3'>
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuItem className='group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300'>
          <svg
